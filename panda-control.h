...
class PandaRobot {
    ...
    public:
        ...
        /**
         * Returns the 7 joint values of the robot.
         *
         * @param[in] robot Robot instance to set behavior on.
         *
         ...
         *
         * @param[in] robot Robot instance to set behavior on.
         * @param[in] p_des 3-elements vector containing the desired xyz position in meters.
         * @param[in] motion_duration desired duration to perform motion.
         */
        void go2Position(franka::Robot* robot, std::array<double, 3> p_des, float motion_duration);
         ...
         * @param[in] robot Robot instance to set behavior on.
         * @param[in] p_des 3-elements vector containing the desired xyz position in meters.
         * @param[in] o_des 4-elements vector containing the desired e_x, e_y, e_z, theta orientation in axis-angle system.
         * @param[in] motion_duration desired duration to perform motion.
         */
        void go2Pose(franka::Robot* robot, std::array<double, 3> p_des, std::array<double, 4> o_des, float motion_duration);
         ...
         *
         * @param[in] robot Robot instance to set behavior on.
         * @param[in] speed_ratio ratio of the maximum speed allowed to move the robot back home.
         */
        void move2HomePosition(franka::Robot* robot, double speed_ratio);
